...
This section is the frozen EV v1 methodology. EV physics implemented. Server integration implemented. Customer form implemented. Result-page EV presentation implemented. PDF still not implemented.
