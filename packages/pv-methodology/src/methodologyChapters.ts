...
export const METHODOLOGY_CHAPTERS: readonly MethodologyChapter[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Für Wasser/Wasser-Wärmepumpen verwendet die Simulation ein gemessenes elektrisches Referenzprofil aus dem WPuQ-Projekt. Das Profil liegt in 15-Minuten-Auflösung vor und stammt von bewohnten Einfamilienhäusern mit einem eigenen Wärmepumpenzähler.",
      "Die Simulation verwendet ein gemessenes Referenzprofil. Ihr angegebener Jahresstromverbrauch bestimmt die Energiemenge. Das Referenzprofil bestimmt deren zeitliche Verteilung über das Jahr.",
      "Das Referenzprofil wird gleichmäßig auf den angegebenen Jahresstromverbrauch skaliert: die zeitliche Struktur bleibt erhalten, die Amplitude folgt dem eingegebenen Jahreswert.",
      "Der Haushaltsstrom bleibt unabhängig von der Wärmepumpe BDEW H25.",
    ],
    bullets: [
      "Technologie: Luft/Wasser oder Wasser/Wasser",
      "Datengrundlage Luft/Wasser: ThermBuild-Messkampagne (Fraunhofer)",
      "Datengrundlage Wasser/Wasser: gemessene elektrische Profile bewohnter Einfamilienhäuser (WPuQ)",
      "Auflösung: elektrisches Lastprofil, 15 Minuten",
      "Jahresstromverbrauch: Energiemenge (wie viel)",
      "Referenzprofil: zeitliche Verteilung über das Jahr (wann)",
    ],
    notes: [
      "Die offiziellen Quellen der ThermBuild- und WPuQ-Wärmepumpenmessungen sind im Abschnitt Quellen verzeichnet.",
    ],
  },
];
